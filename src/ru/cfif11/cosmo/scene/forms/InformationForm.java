...
public class InformationForm extends GraphicForm {
    ...
    private final String[] namePrimitives = new String[] {"selectObj"};
    ...
    private void setSelectObject() {
        ...
        if( world.getSelectObject() == null) {
            prim = new InformGraphPrimitive(x-220, y + 50, 500, 500, 100, 100, "Camera");
            selectObjectName = "Camera";
        } else {
    ...
    private boolean VerifySelectedObject() {
        if(world.getSelectObject() == null)
            return selectObjectName.equals("Camera");
        else
